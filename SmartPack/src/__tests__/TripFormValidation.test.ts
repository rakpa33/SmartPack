...
describe('validateTripForm', () => {
  ...
  describe('when validating city names', () => {
    it('should validate city input', () => {
      const errors = validateTripForm({ 
        ...base, 
        tripName: 'Trip', 
        destinations: ['NotARealCity'], 
  ...
  describe('when validating date logic', () => {
  ...
  describe('when validating complete form', () => {
